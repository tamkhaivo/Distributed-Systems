...
public class ClientServerTests {
    ...
    public void testClientProcessCommunication() throws IOException {
        ...
        // Assert
        // Verify Client sent the correct message format (either READ or WRITE prefix)
        String output = clientOutput.toString();
        assertTrue(output.contains("READ") || output.contains("Client #1"));
